   ...
   <div class="container-fluid">
	<div class="row-fluid">
		...
		<div class="span6">
			...
			<h2>
				<span class="mw-headline" id=".E8.8E.B7.E5.8F.96AccessToken"><strong>AccessToken</strong></span>
				<p>
				<hr></p>
				<%String token =  (String)session.getServletContext().getAttribute("accessToken");%>
				<%=token %>
