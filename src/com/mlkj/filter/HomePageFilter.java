...
public class HomePageFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		//GET  请求获取成员列表
		URL url = new URL("https://qyapi.weixin.qq.com/cgi-bin/user/simplelist?access_token="+accessToken+"&department_id=1&fetch_child=0&status=0");
		...
		request.getRequestDispatcher("WEB-INF/template/showuser.html").forward(request, response);		
	}
